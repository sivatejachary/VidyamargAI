...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_job_discovery",
    )
...
def run_migrations_online() -> None:
    ...
    """
    # Overwrite sqlalchemy.url with the environment variable if available
    import os
    from app.job_discovery import config as cfg
    # Convert asyncpg DSN to standard psycopg2 DSN for Alembic sync operations
    sync_url = os.getenv("JD_DATABASE_URL") or os.getenv("DATABASE_URL") or cfg.DATABASE_URL
