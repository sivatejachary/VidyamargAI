"""
Taleo Adapter — Auto Apply implementation for Taleo.
"""
import logging
...
class TaleoAdapter(BaseApplicationAdapter):
    adapter_version: str = "taleo:1.0"
    platform_key: str = "taleo"
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to Taleo file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on Taleo."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on Taleo."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from Taleo."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on Taleo."""
