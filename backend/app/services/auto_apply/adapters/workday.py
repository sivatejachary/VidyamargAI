"""
Workday Adapter — Auto Apply implementation for Workday.
"""
import logging
...
class WorkdayAdapter(BaseApplicationAdapter):
    adapter_version: str = "workday:1.0"
    platform_key: str = "workday"
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to Workday file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on Workday."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on Workday."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from Workday."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on Workday."""
