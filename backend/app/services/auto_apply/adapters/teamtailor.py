"""
Teamtailor Adapter — Auto Apply implementation for Teamtailor.
"""
import logging
...
class TeamtailorAdapter(BaseApplicationAdapter):
    adapter_version: str = "teamtailor:1.0"
    platform_key: str = "teamtailor"
    ...
    async def create_account(self, context, profile: dict, platform: str) -> dict:
        """Create new account on Teamtailor."""
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to Teamtailor file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on Teamtailor."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on Teamtailor."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from Teamtailor."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on Teamtailor."""
