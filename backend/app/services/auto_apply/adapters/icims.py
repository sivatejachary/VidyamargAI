"""
ICIMS Adapter — Auto Apply implementation for ICIMS.
"""
import logging
...
class ICIMSAdapter(BaseApplicationAdapter):
    adapter_version: str = "icims:1.0"
    platform_key: str = "icims"
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to ICIMS file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on ICIMS."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on ICIMS."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from ICIMS."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on ICIMS."""
