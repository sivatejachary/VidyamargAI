"""
Jobvite Adapter — Auto Apply implementation for Jobvite.
"""
import logging
...
class JobviteAdapter(BaseApplicationAdapter):
    adapter_version: str = "jobvite:1.0"
    platform_key: str = "jobvite"
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to Jobvite file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on Jobvite."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on Jobvite."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from Jobvite."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on Jobvite."""
