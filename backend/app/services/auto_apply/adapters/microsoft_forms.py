"""
MicrosoftForms Adapter — Auto Apply implementation for MicrosoftForms.
"""
import logging
...
class MicrosoftFormsAdapter(BaseApplicationAdapter):
    adapter_version: str = "microsoft_forms:1.0"
    platform_key: str = "microsoft_forms"
    ...
    async def create_account(self, context, profile: dict, platform: str) -> dict:
        """Create new account on MicrosoftForms."""
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to MicrosoftForms file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on MicrosoftForms."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on MicrosoftForms."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from MicrosoftForms."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on MicrosoftForms."""
