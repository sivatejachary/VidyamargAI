"""
Ashby Adapter — Auto Apply implementation for Ashby.
"""
import logging
...
class AshbyAdapter(BaseApplicationAdapter):
    adapter_version: str = "ashby:1.0"
    platform_key: str = "ashby"
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to Ashby file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on Ashby."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on Ashby."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from Ashby."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on Ashby."""
