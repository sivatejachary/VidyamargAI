"""
SuccessFactors Adapter — Auto Apply implementation for SuccessFactors.
"""
import logging
...
class SuccessFactorsAdapter(BaseApplicationAdapter):
    adapter_version: str = "successfactors:1.0"
    platform_key: str = "successfactors"
    requires_password_storage: bool = True  # True only for Workday, Taleo, SuccessFactors, Oracle HCM
    ...
    async def create_account(self, context, profile: dict, platform: str) -> dict:
        """Create new account on SuccessFactors."""
    ...
    async def upload_resume(self, page, resume_bytes: bytes, filename: str) -> bool:
        """Upload resume to SuccessFactors file upload field."""
        try:
    ...
    async def fill_personal_details(self, page, profile: dict) -> bool:
        """Fill personal details on SuccessFactors."""
        filled = 0
        fields = [
    ...
    async def fill_education(self, page, profile: dict) -> bool:
        """Fill education fields on SuccessFactors."""
    ...
    async def capture_confirmation(self, page) -> dict:
        """Capture confirmation from SuccessFactors."""
        try:
    ...
    async def detect_verification_required(self, page) -> Optional[str]:
        """Detect OTP/CAPTCHA/email verification on SuccessFactors."""
