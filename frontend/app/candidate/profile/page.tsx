      ...
      <div className="border-b border-gray-200 dark:border-gray-850 pb-5 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 border border-gray-200 dark:border-gray-800 rounded-xl bg-white dark:bg-[#0c0d14] hover:bg-gray-50 dark:hover:bg-gray-900 text-xs font-bold transition-all text-gray-600 dark:text-gray-300 cursor-pointer"
          >
            {uploading ? <Loader2 size={13} className="animate-spin text-[#6366f1]" /> : <UploadCloud size={13} className="text-[#6366f1]" />}
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer border ${
              isEditMode 
                ...
                : "bg-[#6366f1]/10 border-[#6366f1]/20 hover:bg-[#6366f1]/20 text-[#6366f1]"
            }`}
          >
            <Edit3 size={13} />
      ...
      {!isEditMode ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* User Main Card */}
            <div className="bg-white dark:bg-[#0d0e15] border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm flex flex-col items-center text-center gap-4">
            ...
            <div className="bg-white dark:bg-[#0d0e15] border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm flex flex-col gap-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <div>
                    <span className="text-gray-400 block text-[9px] uppercase font-bold tracking-wider">Phone</span>
                ...
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <div>
                    <span className="text-gray-400 block text-[9px] uppercase font-bold tracking-wider">Address</span>
                ...
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <div>
                    <span className="text-gray-400 block text-[9px] uppercase font-bold tracking-wider">Certifications</span>
              ...
              {skillsList.length === 0 ? (
                ...
                <div className="flex flex-wrap gap-2">
                  {skillsList.map((sk) => (
                    <span 
                      key={sk}
                      className="text-xs font-bold px-3 py-1 rounded-xl bg-purple-50 dark:bg-purple-950/20 text-[#6366f1] dark:text-purple-300 border border-purple-100/40 dark:border-purple-900/10 shadow-sm"
                    >
                      {sk}
                    </span>
                  ))}
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            {/* Experience Timeline */}
            <div className="bg-white dark:bg-[#0d0e15] border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm flex flex-col gap-5">
                ...
                <div className="relative border-l border-gray-200 dark:border-gray-800 ml-3.5 pl-6 space-y-6 py-1">
                  {expList.map((exp: any, idx: number) => (
                    <div key={idx} className="relative">
                      {/* Timeline dot */}
                      <span className="absolute -left-[31px] top-1.5 flex h-3 w-3 items-center justify-center rounded-full bg-white dark:bg-[#07070b] border-2 border-[#6366f1]" />
              ...
              {eduList.length === 0 ? (
                ...
                <div className="relative border-l border-gray-200 dark:border-gray-800 ml-3.5 pl-6 space-y-6 py-1">
                  {eduList.map((edu: any, idx: number) => (
                    <div key={idx} className="relative">
                      {/* Timeline dot */}
                      <span className="absolute -left-[31px] top-1.5 flex h-3 w-3 items-center justify-center rounded-full bg-white dark:bg-[#07070b] border-2 border-purple-500" />
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-[#0d0e15] border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm">
          <form onSubmit={handleSaveProfile} className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="bg-white dark:bg-[#0d0e15] border border-gray-250 dark:border-gray-800 rounded-xl px-4 py-2.5 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-[#6366f1]"
                />
              </div>
              <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                rows={2}
                className="bg-white dark:bg-[#0d0e15] border border-gray-250 dark:border-gray-800 rounded-xl px-4 py-2.5 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-[#6366f1] resize-none"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  rows={5}
                  className="bg-white dark:bg-[#0d0e15] border border-gray-255 dark:border-gray-800 rounded-xl px-4 py-2.5 text-xs text-gray-800 dark:text-white focus:outline-none focus:border-[#6366f1] font-mono resize-none"
                />
              </div>
              <div className="flex flex-col gap-1.5">
            ...
            <div className="flex gap-3 mt-4">
              <button
                type="submit"
                className="flex-1 bg-[#6366f1] hover:bg-[#4f46e5] text-white rounded-xl py-2.5 text-xs font-bold transition-all shadow-sm cursor-pointer"
              >
                Save Information
              </button>
              <button
