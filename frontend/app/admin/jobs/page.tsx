...
export default function AdminJobs() {
  ...
  return (
    <div className="p-8 md:p-12 max-w-6xl mx-auto flex flex-col gap-8">
      ...
      {formOpen ? (
        <form onSubmit={handleCreateJob} className="glass-panel p-8 rounded-2xl border border-gray-800 flex flex-col gap-5 max-w-2xl mx-auto bg-card/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="bg-muted/50 border border-gray-800 rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-purple-500 transition-colors"
              />
            </div>
            <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={5}
              className="bg-muted/50 border border-gray-800 rounded-xl px-4 py-3 text-xs text-white focus:outline-none focus:border-purple-500 transition-colors resize-none leading-relaxed"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {jobs.map((job) => (
            <div key={job.id} className="glass-panel p-6 rounded-2xl border border-gray-800 bg-card/40 flex flex-col justify-between gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-1 mt-4">
                  {(job.required_skills || "").split(",").map((s: string) => (
                    <span key={s} className="text-9 px-2 py-0.5 rounded bg-gray-900 text-gray-400 border border-gray-800">
                      {s.trim()}
                    </span>
                  ))}
                </div>
              ...
              <div className="border-t border-gray-800/80 pt-4 flex justify-between items-center text-10 text-gray-500">
